...
class wugSpider(CrawlSpider):
    ...
    def __init__(self, target = None):
        ...
        if target is not None:
            self.current = target
        self.start_urls = [
            'https://www.wunderground.com/history/airport/ZBAA/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/54618/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZBTJ/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZBYN/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZSSS/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/50888/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/50136/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZYHB/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/50854/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZSOF/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZLXY/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/54602/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/VMMC/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/54401/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/58506/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZGHA/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZSHC/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZHHH/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/58606/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZGGG/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZGSZ/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/53798/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZYTL/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/airport/ZUUU/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/50774/{0}/DailyHistory.html'.format(target),
            'https://www.wunderground.com/history/station/50949/{0}/DailyHistory.html'.format(target)
        ]
        self.rules = (
            Rule(
